...
| `src/Policy/` | `BusinessPolicy`, `ServicePolicy`, `BookingPolicy` - tenant ownership + role checks, resolved by convention (`Authorization.Orm` resolver) from the Entity class name |
