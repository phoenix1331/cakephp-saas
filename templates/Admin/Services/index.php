        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $service->hasValue('business') ? $this->Html->link($service->business->name, ['controller' => 'Businesses', 'action' => 'view', $service->business->id]) : '' ?></td>
                    <td><?= h($service->name) ?></td>
                    <td><?= $this->Number->format($service->duration_minutes) ?></td>
